...
//Funcion que toma dos matrices y las resta
void resta_matriz(int N, int matriz[], int matriz2[]){
	int size=N*N;
	...
	printf("\nResultado de la resta de la matriz 1 y matriz 2: \n");
